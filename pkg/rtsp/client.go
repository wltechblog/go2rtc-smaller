...
import (
	...
	"github.com/wltechblog/go2rtc-smaller/pkg/tcp/websocket"
...
func (c *Conn) Describe() error {
	...
	if c.UserAgent != "" {
		...
		// https://github.com/wltechblog/go2rtc-smaller/issues/235
...
func (c *Conn) SetupMedia(media *core.Media) (byte, error) {
	...
	if !strings.Contains(rawURL, "://") {
		...
		// fix https://github.com/wltechblog/go2rtc-smaller/issues/830
		rawURL = rawURL[7:]
	}
